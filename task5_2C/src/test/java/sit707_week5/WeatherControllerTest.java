...
public class WeatherControllerTest {
    ...
    public static void setUpBeforeClass() {
        controller = WeatherController.getInstance(null);
...
//    }
    ...
    public void testTemperaturePersist() {
        ...
        // Act
        String persistTime = wController.persistTemperature(10, 19.5);
        String now = LocalTime.now(fixedClock).format(DateTimeFormatter.ofPattern("H:m:s"));

        // Assert
        assertEquals("Persisted time mismatch", now, persistTime);
        wController.close();
    }

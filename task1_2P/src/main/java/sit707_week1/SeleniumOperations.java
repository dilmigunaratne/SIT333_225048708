...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from S225048708, DILMI PUNSARA GUNARATNE NAINANGALA VIDANALAGE");
		...
		System.out.println("Window resized to 640 x 480");
		sleep(2);
		...
		System.out.println("Window resized to 1280 x 960");
		sleep(2);
